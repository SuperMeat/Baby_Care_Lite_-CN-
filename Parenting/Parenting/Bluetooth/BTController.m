...
@interface BTController()<UartDelegate>
{
    UartLib *uartLib;
...
+(id)btcontroller
{
    __strong static BTController *_sharedObject = nil;
...
- (void) didBluetoothPoweredOff{
    [self.btControllerDelegate BTPowerOff:YES];
    NSLog(@"power off");
}
...
- (void) didConnectPeripheral:(CBPeripheral *)peripheral{
    ...
    [self.btControllerDelegate DidConnected:YES];
}
...
- (void) didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error{
    ...
    connectPeripheral = nil;
    [self.btControllerDelegate DidConnected:NO];
}
...
- (void) didReceiveData:(CBPeripheral *)peripheral recvData:(NSData *)recvData{
    ...
    [self.btControllerDelegate RecvBTData:recvData];
}
